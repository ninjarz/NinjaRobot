    ...
    O.prototype = {
        ...
        _wheel: function(u) {
            ...
            if (s.options.wheelAction == "zoom") {
                ...
                if (K != s.scale) { ! s.wheelZoomCount && s.options.onZoomStart && s.options.onZoomStart.call(s, u);
                    s.wheelZoomCount++;
        ...
        refresh: function() {
            ...
            if (typeof this.options.snap == "string") {
                ...
                for (s = A.length; u < s; u++) {
                    ...
                    this.pagesY[u] = K.top < this.maxScrollY ? this.maxScrollY: K.top * this.scale
                }
        ...
        z = new g.Class({
            init: function(E, G) {
                ...
                function() {
                    ...
                    for (var K = u._ajaxCallbacks,
                    L = 0,
                    Q = K.length; L < Q; L++) u.proxySend(K[L].url, K[L].option);
                    u._ajaxCallbacks = []
                });
    ...
    function(g) {
        ...
        L = {
            onGetFriendsListSuccess: function(x) {
                ...
                for (var V = {},
                Y = false,
                S = 0; S < I.length; S++) if (I[S].index == 0) Y = true;
        ...
        this.getAvatar = function(x, I) {
            I = I || 1;
            return "http://face" + x % 10 + ".web.qq.com/cgi/svr/face/getface?cache=1&type=" + I + "&f=40&uin=" + x + "&t=" + Math.floor(new Date / 1E3) + "&vfwebqq=" + mq.vfwebqq
        };
